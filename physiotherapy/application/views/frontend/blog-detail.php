                    ...
                    <div class="blog-posts single-post">
                        <article class="post clearfix mb-0">
                            <div class="entry-header">
                                <div class="post-thumb thumb"> <img src="<?php echo base_url($detail_blog->photo); ?>" alt="" class="img-responsive img-fullwidth"> </div>
                            </div>
                            <div class="entry-content">
                                <div class="entry-title pt-0">
                                    <h4><?php echo $detail_blog->title; ?></h4>
                                </div>
                                <div class="entry-meta mb-20">
                                    <ul class="list-inline">
                                        <li>Posted: <span class="text-theme-colored"> <?php echo date('M d, Y',strtotime($detail_blog->date)); ?></span></li>
                                        <li>By: <span class="text-theme-colored">Admin</span></li>
                                        <li><i class="fa fa-comments-o ml-5 mr-5"></i> 5 comments</li>
                                    </ul>
                                </div>
                                <?php echo $detail_blog->body; ?>
