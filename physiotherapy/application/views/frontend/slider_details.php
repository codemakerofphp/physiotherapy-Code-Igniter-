                    ...
                    <div class="blog-posts single-post">
                        <article class="post clearfix mb-0">
                            <div class="entry-header">
                                <div class="post-thumb thumb"> <img src="<?php echo base_url($slider_single_value->photo); ?>" alt="" class="img-responsive img-fullwidth"> </div>
                            </div>
                            <div class="entry-content">
                                <div class="entry-title pt-0">
                                    <h4><?php echo $slider_single_value->title_one.' '.$slider_single_value->title_two ?></h4>
                                </div>
                                <div class="entry-meta mb-20">
                                    <ul class="list-inline">
                                        <li>Posted: <span class="text-theme-colored"> <?php echo date('M d, Y',strtotime($slider_single_value->insert_time)); ?></span></li>
                                        <li>By: <span class="text-theme-colored">Admin</span></li>
                                        <li><i class="fa fa-comments-o ml-5 mr-5"></i> 5 comments</li>
                                    </ul>
                                </div>
                                <?php echo $slider_single_value->body; ?>
