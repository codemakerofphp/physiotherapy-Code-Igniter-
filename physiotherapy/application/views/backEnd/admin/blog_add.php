        ...
        <div class="col-md-12">
            ...
            <div class="box box-danger box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"> <?php echo $this->lang->line('add_blog'); ?> </h3>
                ...
                <div class="box-body">
                    <div class="row">
                        <form action="<?php echo base_url("admin/blog/add");?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <br><br>
                            <div class="col-md-12">
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <input name="date" placeholder="<?php echo $this->lang->line('date'); ?>" class="form-control" required="" type="text" id="date">
                                        </div>
                                    </div>
                                    <!-- Profile Image -->
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <center>
                                                ...
                                                <img id="blog_picture_change" class="img-responsive" src="//placehold.it/400x400" alt="profile picture" style="max-width: 120px;">
                                                <br>
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea name="body" id="blog_editor" cols="" rows="10"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
